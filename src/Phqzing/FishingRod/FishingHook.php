...
class FishingHook extends Projectile {
	...
	public function onHitEntity(Entity $entityHit, RayTraceResult $hitResult):void
	{
		...
		{
			$ev = new EntityDamageByEntityEvent($this->getOwningEntity(), $entityHit, EntityDamageEvent::CAUSE_PROJECTILE, $damage, [], 0.4);
			$entityHit->attack($ev);
			//$entityHit->setMotion($this->getOwningEntity()->getDirectionVector()->multiply(0.3)->add(0, 0.4, 0));
			Loader::setFishing($this->getOwningEntity());
		}
